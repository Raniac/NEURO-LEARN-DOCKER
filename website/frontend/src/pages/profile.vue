...
export default {
  ...
  methods: {
    ...
    showAllProjects () {
      axios.get('/rest/commons/v0/show_all_projects')
        .then(response => {
          var res = response.data
          if (res.error_num === 0) {
            console.log(res)
    ...
    handleJoin (row) {
      axios.get('/rest/commons/v0/join_project?proj_id=' + row.fields.proj_id)
        .then(response => {
          var res = response.data
          if (res.error_num === 0) {
            console.log(res)
    ...
    handleDelete (row) {
      ...
      this.$confirm('Are you sure?', 'Attention!', {
        ...
        axios.get('/rest/commons/v0/delete_project?proj_id=' + row.fields.proj_id)
          .then(response => {
            var res = response.data
            if (res.error_num === 0) {
              console.log(res)
    ...
    handleQuit (row) {
      axios.get('/rest/commons/v0/quit_project?proj_id=' + row.fields.proj_id)
        .then(response => {
          var res = response.data
          if (res.error_num === 0) {
            console.log(res)

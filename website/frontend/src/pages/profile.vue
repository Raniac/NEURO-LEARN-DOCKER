...
export default {
  ...
  methods: {
    showJoinedProjects () {
      axios.get('http://120.79.49.129:1470/api/v0/show_project_overview')
        .then(response => {
    ...
    showAllProjects () {
      axios.get('http://120.79.49.129:1470/api/v0/show_all_projects')
        .then(response => {
          var res = response.data
          if (res.error_num === 0) {
            console.log(res)
    ...
    handleJoin (row) {
      axios.get('http://120.79.49.129:1470/api/v0/join_project?proj_id=' + row.fields.proj_id)
        .then(response => {
          var res = response.data
          if (res.error_num === 0) {
            console.log(res)
    ...
    handleDelete (row) {
      ...
      this.$confirm('Are you sure?', 'Attention!', {
        ...
        axios.get('http://120.79.49.129:1470/api/v0/delete_project?proj_id=' + row.fields.proj_id)
          .then(response => {
            var res = response.data
            if (res.error_num === 0) {
              console.log(res)
    ...
    handleQuit (row) {
      axios.get('http://120.79.49.129:1470/api/v0/quit_project?proj_id=' + row.fields.proj_id)
        .then(response => {
          var res = response.data
          if (res.error_num === 0) {
            console.log(res)
